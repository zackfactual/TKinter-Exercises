...
class Feedback:
    ...
    def __init__(self, master):
        ...
        master.title('Explorifornia Feedback')
        ...
        self.style.configure('Header.TLabel',background='#e1d8b9',font=('Arial',18))
        
        self.frame_header = ttk.Frame(master)
        self.frame_header.pack()
        
        self.logo  = PhotoImage(file='C:\\Users\\User\\Desktop\\TTA Student\\Python\\Ex_Files_Python_Tkinter\\Exercise Files\\Ch08\\tour_logo.gif')
        ttk.Label(self.frame_header,image=self.logo).grid(row=0,column=0,rowspan=2)
        ttk.Label(self.frame_header,text='Thanks for Exploriforning!',style='Header.TLabel').grid(row=0,column=1)
        ttk.Label(self.frame_header,wraplength=300,text=("We're glad you choose Explorifornia for your recent adventure. "
    ...
    def submit(self):
        ...
        self.clear()
        messagebox.showinfo(title='Explorifornia Feedback',message='Thanks for submitting your comments!')
